...
- Fira ansträngning och nyfikenhet. Inget läxgnäll.
- Förbjudna öppningar: "vill du göra läxan", "ska vi räkna lite",
  "mattelektionen", "dags att plugga".
- Om barnet är kallt: byt vinkel. Tvinga inte samma fråga tre gånger.
