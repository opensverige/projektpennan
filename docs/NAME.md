...
### 1. Konkurrentanalytikern

Sverige 2026 är inte tomt. Samma jobb (frågor före facit, åk 4+,
förälder i närheten) heter redan saker.

| Namn | Vad det är | Varför det styr oss |
|------|------------|---------------------|
| [Homework Buddy](https://homeworkbuddy.app/sv/) | Lund, Lgr22, åk 4–uni, “AI-kompis”, frågor före svar | **Buddy är bränt.** Skooli *Buddy* landar i deras knä. |
| [Studybuddy](https://studybuddy.se/om-oss/) | Läxhjälp sedan 2009, 120 000 elever, registrerat varumärke | Buddy *igen*. Allakando säljer dessutom “study buddy” som tjänst. |
| [Pluggis](https://www.pluggis.app/) | Svensk AI-läxhjälp, -is-diminutiv, Draknästet, skolor | **Stjärnis är samma form.** Vi blir “den andra -is-appen”. |
| [Pluggie](https://www.pluggie.se/) | Gymnasiebank med facit | Hela `plugg-` är upptaget. |
| [Allakando AI-lärare](https://www.allakando.se/ai-larare/) | Gratis AI på svenska, åk 1–gymnasium | De döpte den till en *funktion*. Inte en kompis. |
| Skolon *AI-Studiehjälp* | Föräldraapp, skolkedja | Institutionsnamn. Det vi inte ska vara. |
| [Magma](https://edu.se/artikel/basta-matematikappar-2025) / Nomp / [Skolus](https://skolus.se/) | Mattebok, medaljer, spel | Skolverktyg. Inte en kontakt i chatten. |
| [Zapgrade](https://apps.apple.com/se/app/zapgrade-ai-l%C3%A4xhj%C3%A4lp-quiz/id6754518329) | SNAP. ZAP. LEARN. | App-ceremoni. Engelska. Det vi flyr. |

Utanför Sverige, samma mönster:

| Namn | Mönster | Lärdom |
|------|---------|--------|
| [Khanmigo](https://khanmigo.ai/parents) | Org + *amigo*. Sokratisk. $4/mån | Funkar för att Khan redan är ett namn. Vi har inte det. |
| Gauth / Photomath / Question.AI | Facit-motorer | Låter som verktyg. Vi får inte låta så. |
...
Stjärnis är fint. Det är en stjärna som är din. Det fastnar. Det
låter som en kompis i en barnbok.
...
Stjärnis är töntigt. “Stjärna” i skolan är den som räcker upp
handen för mycket. Ingen säger det högt i korridoren. De kan
*använda* något töntigt hemma — de kommer inte *visa* det.

Skooli Buddy är engelska och låter som en app mamma laddat ner.
...
Din intuition stämmer: **bra för 9, dåligt för 12, och vi siktar
på båda.** Plus tre krockar som inte sitter i magkänslan:

1. Samma **-is** som Pluggis, som redan äger den svenska
   AI-läxhyllan.
2. Stjärn-klustret är läromedel och förskola, inte mellanstadium.
3. ASCII-handlen är `stjarnis`. Stjärnan försvinner i Telegram.

**Stjärnis får leva som valfri agent** — ett pack en förälder
sätter på för ett yngre barn. Inte som det namn som står i
chattlistan för alla.
...
| Skooli Buddy | två ord, engelska | meh | cringe | “ännu en AI” | Homework Buddy, Studybuddy | Veto |

**Nästan** (“aldrig facit”) är en mening, inte ett namn. Spara
den till copy.
...
“AI homework helper kids” — Reddit 403, ingen X-nyckel i
last30-scriptet. Konkurrentkartan ovan är sajter och appar,
inte Twitter-humör.
